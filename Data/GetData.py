...
def get_fee_buy():
    ...
    return feeETHUSDT[0]['makerCommission']

def get_fee_sell():
    feeETHUSDT = client.get_trade_fee(symbol='ETHUSDT')
    return feeETHUSDT[0]['takerCommission']
...
def CalCulator_safepoint(_symbol,KlineTime,count):
    ...
    High_Average = Calculator_Average_Listprice(list_low)
    
    return (Low_Average+High_Average)/2
